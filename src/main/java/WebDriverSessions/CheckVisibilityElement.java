...
Notes:
•	isDisplayed() is the method used to verify presence of a web element within the web page.
...
method is pre-dominantly used with radio buttons, drop downs and check boxes.
