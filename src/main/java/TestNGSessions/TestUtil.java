...
public class TestUtil {
	...
	static excel.utility.Xls_Reader reader;
	...
	public static ArrayList<Object[]> getDataFromExcel() {
		...
		try {
			reader = new excel.utility.Xls_Reader(
					"/Users/dileep/Documents/workspace/MorningSessions/src/com/testdata/HalfEbayTestData.xlsx");
		} catch (Exception e) {
			e.printStackTrace();
		}
